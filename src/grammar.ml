...
(NonTerminal Function_or_Subroutine_star_MainProgram,[[NonTerminal Recursive_opt_Function_or_Subroutine;NonTerminal Function_or_Subroutine_star_MainProgram;];[NonTerminal MainProgram;NonTerminal Function_or_Subroutine_star;];]);
(NonTerminal Function_or_Subroutine_star,[[NonTerminal Recursive_opt_Function_or_Subroutine;NonTerminal Function_or_Subroutine_star;];[Terminal E;];]);
(NonTerminal Recursive_opt_Function_or_Subroutine,[[Terminal Recursive;NonTerminal Function_or_Subroutine;];[NonTerminal Function_or_Subroutine;];]);
...
(NonTerminal MainRange,[[NonTerminal BodyConstruct;NonTerminal BodyConstruct_star;NonTerminal Contains_Function_opt_EndProgramStmt;];[NonTerminal Contains_Function_opt_EndProgramStmt;];]);
(NonTerminal Contains_Function_opt_EndProgramStmt,[[NonTerminal Contains_Function;NonTerminal EndProgramStmt;];[NonTerminal EndProgramStmt;];]);
(NonTerminal Contains_Function,[[Terminal Contains;Terminal EOS;NonTerminal FunctionSubprogram_star;];]);
(NonTerminal FunctionSubprogram_star,[[Terminal Recursive;NonTerminal FunctionSubprogram;NonTerminal FunctionSubprogram_star;];[NonTerminal FunctionSubprogram;NonTerminal FunctionSubprogram_star;];[Terminal E;];]);
...
(NonTerminal FunctionRange,[[NonTerminal FunctionParList;NonTerminal FunctionResult_opt;Terminal EOS;NonTerminal BodyConstruct_star;NonTerminal EndFunctionStmt;];]);
...
(NonTerminal FunctionResult_opt,[[Terminal Result;Terminal LParenthesis;NonTerminal VariableName;Terminal RParenthesis;];[Terminal E;];]);
(NonTerminal EndFunctionStmt,[[Terminal EndFunction;NonTerminal EndName_opt;Terminal EOS;];]);
(NonTerminal SubroutineSubprogram,[[Terminal Subroutine;NonTerminal SubroutineName;NonTerminal SubroutineRange;];]);
...
(NonTerminal TypeSpec,[[Terminal Integer;];[Terminal Double;];[Terminal Complex;];[Terminal Logical;];[Terminal Real;];[Terminal Character;];]);
(NonTerminal ExecutableConstruct,[[NonTerminal ActionStmt;];[NonTerminal DoConstruct;];[NonTerminal IfConstructEndif;];[NonTerminal ReturnStmt;];]);
(NonTerminal ReturnStmt,[[Terminal Return;Terminal EOS;];]);
...
(NonTerminal IfConstructEndif,[[NonTerminal IfConstruct;NonTerminal ElseIfConstruct_star;NonTerminal EndIfStmt;];]);
(NonTerminal IfConstruct,[[NonTerminal IfThenStmt;NonTerminal ExecutionPartConstruct_star;];]);
(NonTerminal ElseIfConstruct_star,[[NonTerminal ElseIfConstruct;NonTerminal ElseIfConstruct_star;];[Terminal E;];]);
(NonTerminal ElseIfConstruct,[[Terminal Else;NonTerminal IfConstruct_opt;];]);
(NonTerminal IfConstruct_opt,[[NonTerminal IfConstruct;];[Terminal EOS;NonTerminal ExecutionPartConstruct_star;];]);
...
(NonTerminal Primary,[[Terminal Icon;];[Terminal Rcon;];[Terminal Dcon;];[NonTerminal Name;NonTerminal FunctionReference_opt;];[NonTerminal Scon;];[NonTerminal LogicalConstant;];[Terminal LParenthesis;NonTerminal Expr;Terminal RParenthesis;];]);
(NonTerminal FunctionReference_opt,[[Terminal LParenthesis;NonTerminal FunctionArg_Comma_FunctionArg_star_opt_RParenthesis;];[Terminal E;];]);
(NonTerminal FunctionArg_Comma_FunctionArg_star_opt_RParenthesis,[[NonTerminal FunctionArg;NonTerminal Comma_FunctionArg_star;Terminal RParenthesis;];[Terminal RParenthesis;];]);
(NonTerminal Comma_FunctionArg_star,[[Terminal Comma;NonTerminal FunctionArg;NonTerminal Comma_FunctionArg_star;];[Terminal E;];]);
(NonTerminal FunctionArg,[[NonTerminal Expr;];]);
