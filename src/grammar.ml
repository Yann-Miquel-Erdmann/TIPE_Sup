...
(NonTerminal MainProgram,[[Terminal Program;NonTerminal ProgramName;Terminal Eos;NonTerminal BodyConstruct_star;Terminal EndProgram;NonTerminal EndName_opt;Terminal Eos;];]);
