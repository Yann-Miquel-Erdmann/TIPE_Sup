...
(NonTerminal Contains_Function_opt_EndProgramStmt,[[NonTerminal Contains_Function_opt;NonTerminal EndProgramStmt;];]);
(NonTerminal Contains_Function_opt,[[Terminal Contains;Terminal EOS;NonTerminal FunctionSubprogram_star;];]);
(NonTerminal FunctionSubprogram_star,[[NonTerminal FunctionSubprogram;NonTerminal FunctionSubprogram_star;];[Terminal E;];]);
